...
This is a Node.js / Express.js training/learning project, set by [Codecademy][codecademy], to create an [API][BossMachineProject] to serve a provided 'Boss Machine' application.
...
[GitHubRepo]: https://github.com/BeaumontDan/boss-machine
[BossProject]: https://www.codecademy.com/paths/full-stack-engineer-career-path/tracks/fscp-22-build-a-back-end-with-express-js/modules/wdcp-22-boss-machine/informationals/bapi-p4-boss-machine
